...
/*
notes:-
groupingBy() does two jobs:
Group elements (create buckets)
Process elements inside each bucket ⬅️ this is downstream
📌 Default downstream = Collectors.toList()
----------------------------------------------------------
Collectors.groupingBy(
    classifier,        // how to group
    downstreamCollector // what to do inside each group
)
-----------------------------------------------------------
